...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO customers (name, contact, company_name, balance) VALUES (?, ?, ?, ?)");
    $stmt->execute([$name, $contact, $company, $balance]);
...
<div class="customers-page">
  <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="display: flex; flex-direction: column; align-items: center; text-align: center; margin-bottom: 40px; gap: 12px;">
        ...
        <p style="color: #94a3b8; font-size: 15px; margin: 0;">Fill in the details below to register a new customer</p>
    </div>
        ...
        <form method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" placeholder="e.g. Jane Wanjiru" required>
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="company_name" name="company_name" placeholder="e.g. Acme Logistics">
                </div>
                <div class="form-group">
                    <label for="balance">Opening Balance (KES)</label>
            ...
            <a href="customers.php" class="btn-cancel">⬅️Back to Customer Management</a>
